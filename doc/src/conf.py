# -*- coding: utf-8 -*-
#
# mahler.registry.mongodb documentation build configuration file.
#
...
import mahler.registry.mongodb as registry_plugin
...
project = u'mahler.registry.mongodb'
...
latex_documents = [
  (master_doc, 'mahler.registry.mongodb.tex',
   u'Mahler registry mongodb Documentation',
...
texinfo_documents = [
  (master_doc, 'mongodb',
   u'Mahler registry mongodb Documentation',
   author, 'mongodb', registry_plugin.__descr__,
   'Miscellaneous'),
]
